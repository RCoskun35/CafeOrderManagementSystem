...
{
    public sealed record RegisterCommand(string Email, string FirstName, string LastName, string Password, string RePassword) : IRequest<RegisterCommandResponse>;
        ...
        ) : IRequestHandler<RegisterCommand, RegisterCommandResponse>
    {
        public async Task<RegisterCommandResponse> Handle(RegisterCommand request, CancellationToken cancellationToken)
        {
            ...
            return new RegisterCommandResponse("User registered successfully");
        }
    }
}
